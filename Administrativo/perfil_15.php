<?php
	...
	function opciones_1(Dato)
			{
			if(Dato==463) { modal2('https://app.aoacolombia.com/Control/operativo/zcontrol_operativo3Dev.php',0,0,700,900,'win3'); document.getElementById('sp_1').style.visibility='hidden'; return true;}
					if(Dato==459) { modal2('zrequisicion.php?Acc=ver_balance',0,0,0,0,'destino'); document.getElementById('sp_1').style.visibility='hidden'; return true;}
			...
			<tr><td align='center' style='font-size:14px'><b>OPERATIVO</b></td></tr><tr ><td class='menuprincipal' onclick='opciones_1(463);'>CONTROL</td></tr><tr ><td class='menuprincipal' onclick='opciones_1(459);'>Solicitud de Requisición</td></tr></tr></table></span><center><b style='font-size:13px'><a onclick="document.getElementById('sp_1').style.visibility='visible';">OPERATIVO</a></b></center></td></tr><tr></tr></table><table width='100%' cellspacing=0 cellpaddig=0><tr><td width='100px' valign='top'><a class='info' style='cursor:pointer;' onclick="modal2('https://app.aoacolombia.com/Control/operativo/zcontrol_operativo3Dev.php',0,0,700,900,'win3'); ">
