function add_row()
{
	...
	addtext +="<td height='30' >"+newline+"</td>";
	...
	addtext +="<td height='30' class='writetd' onclick='make_visible("+(parseInt(newline)+parseInt(100))+")' ondblclick='make_invisible("+(parseInt(newline)+parseInt(100))+")'><input class='date_input' id='einput"+newline+"'  type='date'></td>";
