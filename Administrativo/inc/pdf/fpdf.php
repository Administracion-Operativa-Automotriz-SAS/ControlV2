...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		if(!empty($this->Header_texto))
		{
			...
			$this->SetX(($this->ancholinea()-$Posicion_titulo)/2+10);  #Define la posici�n desde el borde izquierdo
			...
			//Salto de l�nea
			$this->Ln($this->Header_alto);  #el par�metro es el alto de linea.
		}
	...
	function AcceptPageBreak()
	{
		...
		if($this->Columna < $this->Columnas)    ##  aqui es donde se controla el numero de columnas. si se retorna verdadero, hace salto de p�gina utom�tico
			if($this->Columna < 3)    ##  aqui es donde se controla el numero de columnas. si se retorna verdadero, hace salto de p�gina utom�tico
			{
	...
	function Footer()
	{
		...
		if(!empty($this->Footer_texto))
		{
			...
			//Salto de l�nea
			$this->Ln($this->Footer_alto);  #el par�metro es el alto de linea.
		}
		###############################################################################################
		//Posici�n: a 1,5 cm del final
		$this->SetY(-15);   #Posiciona el control a partir del borde superior o inferior de la p�gina, si el valor es negativo es con respecto al borde inferior
		//Arial italic 8
		$this->SetFont('Arial','I',8);
		//Color del texto en gris
		$this->SetTextColor(128); #con un par�metro nivel de grises, los tres par�metros son RGB
		//N�mero de p�gina
		if($this->Numeracion)
		$this->Cell(0,10,'P�gina '.$this->PageNo().'/{nb}',0,0,$this->Footer_alineacion_pagina); #pageno() devuelve el n�mero de la p�gina actual. {nb} es utilizado por AliasNBPages() para sustituirlo al final cuando se cierre el documento y mostrar� el total de las p�ginas.
	}
