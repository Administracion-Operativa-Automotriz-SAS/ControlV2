function re_sesion()
{
  if(confirm('Su sesion ha expirado. Desea recuperar la sesion?'))
  {
      ...
      doc.write("<meta http-equiv='Cache-Control' content='no-cache; must-revalidate; proxy-revalidate; max-age=10'>");
       doc.write("<style type='text/css'>@import url(inc/css/estilo.css); .g-recaptcha div {display: block; margin-right: auto; margin-left: auto; }</style>");
      doc.write("<script language='javascript' src='inc/js/aqrenc.js'></script><script language='javascript' src='inc/js/funciones.js'></script> <script src='https://www.google.com/recaptcha/api.js'></script></head>");
	  ...
	  doc.write("<div class='g-recaptcha' data-sitekey='6LfWLiUTAAAAABMwEwNpKgKrta-HGtZ1OzWnWgMj'></div>");
      ...
      doc.write("</center><iframe name='sp' id='sp' height='100' width='100%' scrolling='no' frameborder='no' style='visibility:visible;'></iframe></form></body></html>");
      doc.close();
  }
}