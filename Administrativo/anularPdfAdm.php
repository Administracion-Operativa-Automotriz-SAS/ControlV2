...
$ER=qo("select  
	...
	$pdf->setXY(10,90);
		...
		$pdf->Cell(45,5,utf8_decode($Prov->nombre),1,1,'C',1);
		...
		$pdf->Cell(45,5,utf8_decode($Prov->ciudad),1,1,'C',1);
		...
		$pdf->setXY(141,115);
			...
			$pdf->Cell(59,5,utf8_decode($Prov->direccion),1,1,'C',1);
		...
		$pdf->SetFont('Arial','B',7);
		$pdf->SetFillColor(	255, 255, 255);	
		$pdf->Cell(45,5,utf8_decode($Prov->contacto),1,1,'C',1);
		$pdf->SetFont('Arial','B',7);
		$pdf->setXY(100,120);
			$pdf->SetFillColor(	215, 240, 127);	
    ...
    $pdf->SetFillColor(215, 240, 127);
        ...
        $pdf->SetFont('Arial','',7);
		    ...
		    $yPos=$pdf->GetY();
				$pdf->SetFillColor(255, 255, 255);
		    $pdf->MultiCell($cellWidth,$cellHeight  -2,$observacions,1,1,1);
