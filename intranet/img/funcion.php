...
include_once('../Administrativo/config/config.php');
 $minCss=' <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet">';

 $business = '<link href="bootstrap/css/modern-business.css" rel="stylesheet">';

if(GLOBALES) require_once('../Administrativo/inc/gpos.php');

if(!function_exists('file_put_contents')) include('../Administrativo/inc/func_php5.php');

if(defined('ENCRIPCION'))
{
if(ENCRIPCION >= 1)	switch(ENCRIPCION)
	{	case 2:include('../Administrativo/inc/encripcion_2.php');break;
		case 3:include('../Administrativo/inc/encripcion_3.php');break;
		default: include('../Administrativo/inc/encripcion_1.php');}}
	else include('../Administrativo/inc/encripcion_1.php');
...
include('../Administrativo/config/resuelve.php');
...
function prepara_rutinas($Acc)  // Si la Acción corresponde a opciones especiales incluye el archivo que las contiene
{
	...
	else include_once('../Administrativo/inc/menu_inicio.php');
}
...
function ingreso_sistema() // funcion que presenta la ventana de ingreso de usuario y clave
{
	session_start();
	session_unset();session_destroy();
	define('CSSPATH', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/'); //define css path
  $cssItem = 'font-awesome.min.css'; //css item to display
   $minCss=' <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet">';
...
<h1 style='text-align:center' class='texto-bold-titulo-1'> Administración  AOA Colombia</h1>
...
<INPUT TYPE='text'  class='btn paddingcero   ' id='usuario'  NAME='Usuario' MAXLENGTH='30' placeholder='Usuario'
  title='Ingresar el usuario ' SIZE='20'>
  </INPUT>
 <div></div>
</div>
<div class='formulario-entrada-der row'>
       <input   class='btn paddingcero col-sm-8'  style='width: 80%;' ID='txtPassword' NAME='Clave' type='Password' placeholder='Contraseña'
  title='Ingresar el contraseña ' SIZE='20'>
       <button id='show_password' type='button' style='  position: absolute;
  left: 78%;
  margin-top: 23;
  padding: 9px 8px;
\  color: #aaa;
  transition: 0.3s; float:left;  width: 15%; background-color: #76881d;'
	   class='btn btn-success paddingcero col-sm-1' type='button' onclick='mostrarPassword()'> 
...
<div class='contenedor-enviar'>           
                    <div class='checkbox' id='captcha' data-callback='YourOnSubmitFn'></div>  
              </div>
			  <div class='contenedor-enviar'> 
...
<form action='../Administrativo/valida_entrada.php' method='post' target='_self' name='forma' id='forma'>
...
#
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
include('../Administrativo/inc/funciones_smtp.php');
