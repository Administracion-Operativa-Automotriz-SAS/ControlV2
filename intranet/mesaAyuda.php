...
<html lang="en-US">
	...
	<head>
		...
		<!--// WORDPRESS HEAD HOOK //-->
		<title>Mesa de ayuda AOA Colombia &#8211; AOA Colombia</title>
...
<h1 style="text-align:center" class="texto-bold-titulo-1"> Mesa De Ayuda  AOA Colombia</h1>
...
<h3>Bienvenido a la Mesa De Ayuda  </h3>
<p>Este es el acceso a  Mesa De Ayuda  de AOA Colombia</p>
<div class="contenedor-formulario-entrada-izq-der">
<div class="formulario-entrada-izq">
<span class="wpcf7-form-control-wrap usuario"><input type="text" name="usuario" value="" size="40" maxlength="30" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required ancho-cedula" id="usuario" aria-required="true" aria-invalid="false" placeholder="Usuario" /></span>
</div>
<div class="formulario-entrada-der">
<span class="wpcf7-form-control-wrap clave"><input type="number" name="clave" value="" class="wpcf7-form-control wpcf7-number wpcf7-validates-as-required wpcf7-validates-as-number ancho-cedula" id="clave" aria-required="true" aria-invalid="false" placeholder="Contaseña" /></span>
</div>
</div>
<div class=" contenedor-enviar text-center">
<div class="g-recaptcha text-center " data-sitekey="6Ld-3OAUAAAAAI49_SbKJQC2qB0HOi3wsaCGsCIr"></div>
</div>
<div class="contenedor-enviar">
<input type="submit" value="Ingresar" class="wpcf7-form-control wpcf7-submit" id="acceso-clave" />
</div>
</div>
