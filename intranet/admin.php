...
include_once('../Administrativo/inc/funcion.php');
...
<html lang="en-US">
	...
	<head>
		...
		<!--// WORDPRESS HEAD HOOK //-->
		<title>Administrador  AOA Colombia &#8211; AOA Colombia</title>
...
<script type="text/javascript">function setREVStartSize(a){try{var b,c=document.getElementById(a.c).parentNode.offsetWidth;if(c=0===c||isNaN(c)?window.innerWidth:c,a.tabw=void 0===a.tabw?0:parseInt(a.tabw),a.thumbw=void 0===a.thumbw?0:parseInt(a.thumbw),a.tabh=void 0===a.tabh?0:parseInt(a.tabh),a.thumbh=void 0===a.thumbh?0:parseInt(a.thumbh),a.tabhide=void 0===a.tabhide?0:parseInt(a.tabhide),a.thumbhide=void 0===a.thumbhide?0:parseInt(a.thumbhide),a.mh=void 0===a.mh||""==a.mh?0:a.mh,"fullscreen"===a.layout||"fullscreen"===a.l)b=Math.max(a.mh,window.innerHeight);else{for(var d in a.gw=Array.isArray(a.gw)?a.gw:[a.gw],a.rl)(void 0===a.gw[d]||0===a.gw[d])&&(a.gw[d]=a.gw[d-1]);for(var d in a.gh=void 0===a.el||""===a.el||Array.isArray(a.el)&&0==a.el.length?a.gh:a.el,a.gh=Array.isArray(a.gh)?a.gh:[a.gh],a.rl)(void 0===a.gh[d]||0===a.gh[d])&&(a.gh[d]=a.gh[d-1]);var e,f=Array(a.rl.length),g=0;for(var d in a.tabw=a.tabhide>=c?0:a.tabw,a.thumbw=a.thumbhide>=c?0:a.thumbw,a.tabh=a.tabhide>=c?0:a.tabh,a.thumbh=a.thumbhide>=c?0:a.thumbh,a.rl)f[d]=a.rl[d]<window.innerWidth?0:a.rl[d];for(var d in e=f[0],f)e>f[d]&&0<f[d]&&(e=f[d],g=d);var h=c>a.gw[g]+a.tabw+a.thumbw?1:(c-(a.tabw+a.thumbw))/a.gw[g];b=a.gh[g]*h+(a.tabh+a.thumbh)}void 0===window.rs_init_css&&(window.rs_init_css=document.head.appendChild(document.createElement("style"))),document.getElementById(a.c).height=b,window.rs_init_css.innerHTML+="#"+a.c+"_wrapper { height: "+b+"px }"}catch(a){console.log("Failure at Presize of Slider:"+a)}};</script>
		<style type="text/css" id="wp-custom-css">
			hr.linea-inicio-seccion {
	border-top: 2px dashed #003057;
  width: 90%;
...
.contador-usuarios-nacional { margin: 0 0 0 0;
padding: 0 0 0 0;
	color: #003057;
}
.columna {
...
.formato-consultar-pqr {
	margin: -100px 0 0 0;
}
.formulario-contacto,
.formulario-pqr,
.formulario-consultar-pqr,
...
.formulario-pqr h3,
.formulario-consultar-pqr h3 {
	color: rgba(0,48,87,1);
	font-weight: bold;
	word-break: keep-all;
	text-align:center;
	background-color: rgba(168,173,0,0.1);
	margin: 0 0 10px 0;
	padding: 10px 0 10px 0;
	width: 100%;
}
.formulario-acceso-clientes h3,
...
.formulario-acceso-clientes p,
.formulario-entrada p {
	color: rgba(0,48,87,1);
	font-weight: bold;
	word-break: keep-all;
	text-align:center;
...
.formulario-contacto .contenedor-formulario-izq-der,
.formulario-pqr .contenedor-formulario-izq-der,
.formulario-consultar-pqr .contenedor-formulario-consultar-izq-der,
.formulario-acceso-clientes .contenedor-formulario-acceso-clientes-izq-der,
.formulario-entrada .contenedor-formulario-entrada-izq-der {
	display: flex;
}
.formulario-contacto .formulario-contacto-izq,
.formulario-pqr .formulario-contacto-izq,
.formulario-consultar-pqr .formulario-consultar-izq,
.formulario-acceso-clientes .formulario-acceso-clientes-izq,
.formulario-entrada .formulario-entrada-izq {
	display: flex;
	flex: 1;
	flex-direction: column;
	padding: 0 10px 0 10px;
}
.formulario-contacto .formulario-contacto-der,
.formulario-pqr .formulario-contacto-der,
.formulario-consultar-pqr .formulario-consultar-der,
.formulario-acceso-clientes .formulario-acceso-clientes-der,
.formulario-entrada .formulario-entrada-der {
	display: flex;
	flex: 1;
	flex-direction: column;
	padding: 0 10px 0 10px;
...
.formulario-pqr input[type="text"],
.formulario-pqr input[type="email"],
.formulario-pqr input[type="tel"],
.formulario-pqr input[type="number"],
.formulario-consultar-pqr input[type="number"],
.formulario-acceso-clientes input[type="text"],
.formulario-acceso-clientes input[type="number"],
.formulario-entrada input[type="text"],
.formulario-entrada input[type="number"] {
	background-color: rgba(255,255,255,0);
	border-style: solid;
...
.formulario-contacto .custom-select,
.formulario-pqr .custom-select,
.formulario-consultar-pqr .custom-select {
	position: relative;
	margin: 5px 10px 15px 0;
	word-break: keep-all;
}
.formulario-contacto .custom-select select,
.formulario-pqr .custom-select select,
.formulario-consultar-pqr .custom-select select {
	display: none;
}
.formulario-contacto .select-selected,
.formulario-pqr .select-selected,
.formulario-consultar-pqr .select-selected {
	background-color: rgba(242,243,217,0.3);
	margin: 5px 0 0 0;
	padding: 8px 8px;
		}
.formulario-contacto .select-selected:after,
.formulario-pqr .select-selected:after,
.formulario-consultar-pqr .select-selected:after {
	position: absolute;
	content: "";
	top: 50px;
	right: 10px;
...
.formulario-contacto .select-selected.select-arrow-active:after,
.formulario-pqr .select-selected.select-arrow-active:after,
.formulario-consultar-pqr .select-selected.select-arrow-active:after {
	border-color: transparent transparent #a8ad00 transparent;
	top: 42px;
}
.formulario-contacto .select-items div,.select-selected,
.formulario-pqr .select-items div,.select-selected,
.formulario-consultar-pqr .select-items div,.select-selected {
	color: rgba(0,48,87,1);
	padding: 8px 8px;
	border: 1px solid transparent;
	border-color: transparent transparent rgba(168, 173, 0, 0.7) transparent;
	cursor: pointer;
	user-select: none;
}
.formulario-contacto .select-items,
.formulario-pqr .select-items,
.formulario-consultar-pqr .select-items  {
	position: absolute;
	background-color: rgba(239,239,189,0.9);
	top: 100%;
	left: 0;
	right: 0;
	z-index: 99;
}
.formulario-contacto .select-hide,
.formulario-pqr .select-hide,
.formulario-consultar-pqr .select-hide {
	display: none;
}
.formulario-contacto .select-items div:hover, .same-as-selected,
.formulario-pqr .select-items div:hover,
.formulario-consultar-pqr .select-items div:hover {
	background-color: rgba(168,173,0,0.3);
}
.formulario-contacto textarea,
.formulario-pqr textarea,
.formulario-consultar-pqr textarea {
...
.formulario-contacto .contenedor-areatexto,
.formulario-pqr .contenedor-areatexto,
.formulario-consultar-pqr .contenedor-areatexto {
	margin: 0 0 0 8px;
}
.formulario-contacto .contenedor-enviar,
.formulario-pqr .contenedor-enviar,
.formulario-consultar-pqr .contenedor-enviar,
.formulario-acceso-clientes .contenedor-enviar,
.formulario-entrada .contenedor-enviar {
	display: flex;
	justify-content: center;
}
.formulario-contacto #enviar,
.formulario-pqr #enviar-pqr,
.formulario-consultar-pqr #consular-pqr,
.formulario-acceso-clientes #acceso-clientes,
.formulario-entrada #acceso-clave {
	width: 120px;
	color: #fff;
	background-color: rgba(168,173,0,1);
	padding: 10px 20px 10px 20px;
...
.formulario-pqr #enviar-pqr:hover,
.formulario-consultar-pqr #consular-pqr:hover,
.formulario-acceso-clientes #acceso-clientes:hover,
.formulario-entrada #acceso-clave:hover {
	background-color: rgba(118,136,29,1);
		}
.formulario-contacto #enviar:focus,
.formulario-pqr #enviar-pqr:focus,
.formulario-consultar-pqr #consultar-pqr:focus,
.formulario-acceso-clientes #acceso-clientes:focus,
.formulario-entrada #acceso-clave:focus {
	background-color: rgba(168,173,0,1);
}
.ancho-placa-vehiculo,
.ancho-cedula {
	width: 95%;
}
.separador-azul {
...
.franja-informacion img.logo-AOA-principal {
	width: 180px;
	height: 90px;
}
.informacion-oficina {
...
.franja-informacion img.logo-asorenting {
	width: 144px;
	height: 80px;
}
...
.ancho-columnas-servicios {
	width: 70%;
	text-align: justify;
	margin: 0 15% 0 15%;
}
.espaciado-columnas-servicios {
	padding: 0 5% 0 5%;
}
.ancho-columnas-contacto {
	width: 60%;
	text-align: justify;
	margin: 30px 20% 0 20%;
}
.ancho-columnas-servicios-color {
	width: 70%;
	text-align: justify;
	margin: 0 15% 0 15%;
}
.parrafo-columnas-servicios {
	padding: 0 5% 0 5%;
	margin: 20px 5% 0 5%;
	border: 1px solid #a8ad00;
...
.contacto-aseguradora p.titulo-datos {
	font-size: 1.2em;
	font-weight: bold;
	text-align: left;
}
...
.contacto-aseguradora button {
	text-align: center;
	margin-bottom: 10px;
}
#89.page-content.clearfix {
		border: 1px solid #a8ad00;
}
.colaboradores {
	margin: 40px 0 0 0;
...
.datos-contacto-1 img,
.datos-contacto-2 img {
	width: 45px;
	height: 45px;
	margin: 20px 0 0 0;
}
...
.formulario-contacto #enviar,
.formulario-pqr #enviar-pqr,
.formulario-consultar-pqr #consultar-pqr,
.formulario-acceso-clientes #acceso-clientes,
.formulario-entrada #acceso-clave {
	width: 140px;
	color: #fff;
...
.formulario-contacto #enviar:hover,
.formulario-pqr #enviar-pqr:hover,
.formulario-consultar-pqr #consultar-pqr:hover,
.formulario-acceso-clientes #acceso-clientes:hover,
.formulario-entrada #acceso-clave:hover {
	background-color: rgba(118,136,29,1);
		}
...
<a href="https://www.creativografico.dev/webAOA">
<img class="standard" src="https://www.creativografico.dev/webAOA/wp-content/uploads/2019/09/cropped-logotipo-aoa-colombia-1.png" alt="AOA Colombia" width="500" height="50" />
</a>
...
<div class="menu-aoa-principal-container"><ul id="menu-aoa-principal-1" class="menu"><li  class="menu-item-787 menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-has-children       " ><a title="Servicios integrales de movilidad" href="https://www.creativografico.dev/webAOA/">Servicios<span class="nav-line"></span></a>
<ul class="sub-menu">
	<li  class="menu-item-100 menu-item menu-item-type-post_type menu-item-object-page       " ><a title="Vehículo de Reemplazo AOA Colombia" href="https://www.creativografico.dev/webAOA/index.php/vehiculo-de-reemplazo/">Vehículo de Reemplazo</a></li>
	<li  class="menu-item-99 menu-item menu-item-type-post_type menu-item-object-page       " ><a title="Renta de Vehículos AOA Colombia" href="https://www.creativografico.dev/webAOA/index.php/renta-de-vehiculos/">Renta de Vehículos</a></li>
	<li  class="menu-item-98 menu-item menu-item-type-post_type menu-item-object-page       " ><a title="Renting Operativo AOA Colombia" href="https://www.creativografico.dev/webAOA/index.php/renting-operativo/">Renting Operativo</a></li>
...
<li  class="menu-item-74 menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children       " ><a title="Conócenos Información Corporativa AOA Colombia" href="https://www.creativografico.dev/webAOA/index.php/informacion-corporativa-aoa-colombia/">Conócenos<span class="nav-line"></span></a>
<ul class="sub-menu">
	<li  class="menu-item-1174 menu-item menu-item-type-post_type menu-item-object-page       " ><a title="Nuestra Empresa Información Corporativa AOA Colombia" href="https://www.creativografico.dev/webAOA/index.php/informacion-corporativa-aoa-colombia/">Nuestra Empresa</a></li>
	<li  class="menu-item-2578 menu-item menu-item-type-custom menu-item-object-custom       " ><a href="https://www.creativografico.dev/webAOA/index.php/informacion-corporativa-aoa-colombia/#mision">Misión</a></li>
	<li  class="menu-item-2577 menu-item menu-item-type-custom menu-item-object-custom       " ><a href="https://www.creativografico.dev/webAOA/index.php/informacion-corporativa-aoa-colombia/#vision">Visión</a></li>
...
<li  class="menu-item-73 menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children       " ><a title="Contacto AOA Colombia" href="https://www.creativografico.dev/webAOA/index.php/contacto-aoa-colombia/">Contacto<span class="nav-line"></span></a>
<ul class="sub-menu">
	<li  class="menu-item-1306 menu-item menu-item-type-post_type menu-item-object-page       " ><a title="Call Center AOA Colombia" href="https://www.creativografico.dev/webAOA/index.php/contacto-aoa-colombia/">Call Center</a></li>
	<li  class="menu-item-1305 menu-item menu-item-type-post_type menu-item-object-page       " ><a href="https://www.creativografico.dev/webAOA/index.php/contacto-por-aseguradora/">Contacto por Aseguradora</a></li>
	<li  class="menu-item-1333 menu-item menu-item-type-post_type menu-item-object-page       " ><a title="FAQ AOA Colombia" href="https://www.creativografico.dev/webAOA/index.php/faq-aoa-colombia/">Preguntas Frecuentes</a></li>
...
<li  class="menu-item-82 menu-item menu-item-type-post_type menu-item-object-page       " ><a title="Clientes AOA Colombia" href="https://www.creativografico.dev/webAOA/index.php/clientes-aoa-colombia/">Clientes<span class="nav-line"></span></a></li>
<li  class="menu-item-81 menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-79 current_page_item       " ><a title="Intranet AOA Colombia" href="https://www.creativografico.dev/webAOA/index.php/intranet-aoa-colombia/">Intranet<span class="nav-line"></span></a></li>
</ul></div></nav>
...
<h1 style="text-align:center" class="texto-bold-titulo-1"> Control  AOA Colombia</h1>



<pre class="wp-block-code acceso-clientes"><code><div role="form" class="wpcf7" id="wpcf7-f2481-p79-o1" lang="en-US" dir="ltr">
<div class="screen-reader-response"></div>
<form action="/webAOA/index.php/intranet-aoa-colombia/#wpcf7-f2481-p79-o1" method="post" class="wpcf7-form" novalidate="novalidate">
<div style="display: none;">
<input type="hidden" name="_wpcf7" value="2481" />
<input type="hidden" name="_wpcf7_version" value="5.1.4" />
<input type="hidden" name="_wpcf7_locale" value="en_US" />
<input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f2481-p79-o1" />
<input type="hidden" name="_wpcf7_container_post" value="79" />
</div>
<div class="formulario-entrada">
<h3>Bienvenido Administrador  </h3>
<p>Este es el acceso a Administrador  de AOA Colombia</p>

<div class="contenedor-enviar">
<a href="https://app.aoacolombia.com/intranet/admin.php?Acc=ingreso_sistema&SESION_PUBLICA=1">
<input  value="Ingresar"  id="acceso-clave" />
</a>
</div>
</div>
<div class="wpcf7-response-output wpcf7-display-none"></div></form></div></code></pre>
