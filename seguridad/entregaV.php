    ...
    <div class='slide-one-item home-slider owl-carousel'>
      ...
      <div class='site-blocks-cover inner-page overlay'  loading='lazy'  style='background-image: url(images/covid.jpg);' data-aos='fade' data-stellar-background-ratio='0.5'>
        <div class='container'>
          <div class='row align-items-center justify-content-center'>
	       ...
	       <div class='site-blocks-cover inner-page overlay'  loading='lazy'  style='background-image: url(images/con30.png);' data-aos='fade' data-stellar-background-ratio='0.5'>
        <div class='container'>
          <div class='row align-items-center justify-content-center'>
            <div class='col-md-12 text-center' data-aos='fade'>
      ...
      <div class='site-blocks-cover inner-page overlay'   loading='lazy' style='background-image: url(images/con21.jpg);' data-aos='fade' data-stellar-background-ratio='0.5'>
        <div class='container'>
          <div class='row align-items-center justify-content-center'>
            <div class='col-md-12 text-center' data-aos='fade'>
              <h1 class='font-secondary font-weight-bold text-uppercase'>Protocolo Devolución de Vehículos</h1>
            </div>
          </div>
        </div>
      </div> 
   ...
   <BR>
    ...
    <div class='site-section section-counter'>
      <div class='container'>
        <div class='row'>
          <div class='col-lg-5'>
            <p class='mb-5'><img  loading='lazy'  src='images/CAR45.jpg' alt='Image' class='img-fluid'></p>
          </div>
      ...
      <div class='container'>
        ...
        <div class='row'>
          ...
          <div class='col-md-6 col-lg-4 mb-5' data-aos='fade-up' data-aos-delay='200'>
            <div class='media-image'>
              <a href='single.html'><img  loading='lazy'  src='images/co97.jpg' alt='Image' class='img-fluid'></a>
              <div class='media-image-body'>
