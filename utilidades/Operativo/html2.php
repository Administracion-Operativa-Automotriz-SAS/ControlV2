<?php
 echo "<body><script language='javascript'>alert('Email enviado itt6786');</script></body>";
echo "w45423534erwr";
  ...
  <![endif]-->
		...
		<header>
		   <table   style=' text-align: center;' align='center' width='570' cellpadding='0' cellspacing='0' role='presentation'>
				...
				<br>
                  ...
                  <tr>
                    <td   style=' text-align: center;'  class='content-cell' align='center' >
                       <b  style='margin-bottom: 5%;  color: 1px solid rgba(118,136,29,1);' class='titulo'>Notificación de No  Aprobación de Requisición  &nbsp; $id</b><br> </td>
                  </tr>
		...
		<hr>
         ...
         <address contenteditable style='margin-bottom: 1%; '>
			   <h3 style='margin-bottom: 1%;'>Número de Requisición: &nbsp; $id</h3>
				<p>Aprobado : &nbsp; $user [$email]</p>
