...
<?php
	...
	$user=UrlEncode("arturoquintero@aoacolombia.com");
	$password=UrlEncode("Tabio2012+");
	...
	$message=1;
	$message_file='pop3://'.$user.':'.$password.'@aoacolombia.com/'.$message.
	 ...
	 */
 	...
 	//$message_file='pop3://'.$user.':'.$password.'@aoacolombia.com:110/1?tls=1&debug=1&html_debug=1';
