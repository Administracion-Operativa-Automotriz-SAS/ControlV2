...
/**/
#############################################################################################################
// 1. Llamar a la funcion getDataAllFlote del servidor
$resultTotalData = $cliente->call(	"getDataAllFlote", 									// Funcion a llamar
							 array (													// Parametros pasados a la funcion
							 		"token" => $token,									//	Token
							 		"flagGetData" => '2',								//	paramFlag
							 		"minorDate" => '2012-08-27 15:00:00',				//	minorDate
							 		"minorDate" => '2012-08-27 17:40:00'				//	majorDate
									), 													
							"uri:$serverURL/$serverScript", 							// namespace
						 	"uri:$serverURL/$serverScript/getDataAllFlote" 				// SOAPAction
						);
 	...
 	echo '</b>';
 		...
 		if ($error) {
 			echo '<b style="color: red">Error: ' . $error . '</b>';
 				...
 				echo 'Respuesta Total Data (30 Min.): '.$resultTotalData;
 				}
	}
/*
#############################################################################################################
