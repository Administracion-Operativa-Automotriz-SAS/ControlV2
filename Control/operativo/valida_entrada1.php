...
$ENCONTRADO=0;
if($R=qo("select * from aoacol_aoacars.usuario where strcmp(idnombre,'$IDuser')=0"))
{
...
if($S1=q("select * from aoacol_aoacars.usuario where LENGTH(alt_tabla)>0 && LENGTH(alt_id)>0 && LENGTH(alt_pass)>0 && LENGTH(alt_nombre)>0"))
{
	...
	IF (!$ENCONTRADO)
	{
		...
		echo "
				...
				<ul class='sub-menu.>
					<li  class='menu-item-100 menu-item menu-item-type-post_type menu-item-object-page   '><a title='Vehículo de Reemplazo AOA Colombia' href='https://www.aoacolombia.com/index.php/vehiculo-de-reemplazo/'>Vehículo de Reemplazo</a></li>
					<li  class='menu-item-99 menu-item menu-item-type-post_type menu-item-object-page   '><a title='Renta de Vehículos AOA Colombia' href='https://www.aoacolombia.com/index.php/renta-de-vehiculos/'>Renta de Vehículos</a></li>
				...
				<li  class='menu-item-74 menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children   '><a title='Conócenos Información Corporativa AOA Colombia' href='https://www.aoacolombia.com/index.php/informacion-corporativa-aoa-colombia/'><span class='menu-item-text'>Conócenos<span class='nav-line'></span></span></a>
				<ul class='sub-menu'>
					<li  class='menu-item-1174 menu-item menu-item-type-post_type menu-item-object-page   '><a title='Nuestra Empresa Información Corporativa AOA Colombia' href='https://www.aoacolombia.com/index.php/informacion-corporativa-aoa-colombia/'>Nuestra Empresa</a></li>
					<li  class='menu-item-2578 menu-item menu-item-type-custom menu-item-object-custom   '><a href='https://www.aoacolombia.com/index.php/informacion-corporativa-aoa-colombia/#mision'>Misión</a></li>
					<li  class='menu-item-2577 menu-item menu-item-type-custom menu-item-object-custom   '><a href='https://www.aoacolombia.com/index.php/informacion-corporativa-aoa-colombia/#vision'>Visión</a></li>
					<li  class='menu-item-2583 menu-item menu-item-type-custom menu-item-object-custom   '><a href='https://www.aoacolombia.com/index.php/informacion-corporativa-aoa-colombia/#politica-sistema-gestion-calidad'>Política Sistema de la Gestión de Calidad</a></li>
				...
				<ul class='sub-menu'>
					...
					<li  class='menu-item-1302 menu-item menu-item-type-post_type menu-item-object-page   '><a href='https://www.aoacolombia.com/index.php/politica-de-proteccion-de-datos/'>Política de Protección de Datos</a></li>
					<li  class='menu-item-1301 menu-item menu-item-type-post_type menu-item-object-page   '><a href='https://www.aoacolombia.com/index.php/politica-anticorrupcion/'>Política Anticorrupción</a></li>
				...
				<li  class='menu-item-74 menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children       ' ><a title='Conócenos Información Corporativa AOA Colombia' href='https://www.aoacolombia.com/index.php/informacion-corporativa-aoa-colombia/'>Conócenos<span class='nav-line'></span></a>
				<ul class='sub-menu'>
					<li  class='menu-item-1174 menu-item menu-item-type-post_type menu-item-object-page       ' ><a title='Nuestra Empresa Información Corporativa AOA Colombia' href='https://www.aoacolombia.com/index.php/informacion-corporativa-aoa-colombia/'>Nuestra Empresa</a></li>
					<li  class='menu-item-2578 menu-item menu-item-type-custom menu-item-object-custom       ' ><a href='https://www.aoacolombia.com/index.php/informacion-corporativa-aoa-colombia/#mision'>Misión</a></li>
					<li  class='menu-item-2577 menu-item menu-item-type-custom menu-item-object-custom       ' ><a href='https://www.aoacolombia.com/index.php/informacion-corporativa-aoa-colombia/#vision'>Visión</a></li>
				...
				<h1 style='text-align:center' class='texto-bold-titulo-1'>Error al ingresar a Control</h1>
				 ...
				 <div class='text-center'>
                  <a type='button' style='background-color: #a8ad00!important;' href='https://app.aoacolombia.com/intranet/control.php?Acc=ingreso_sistema&SESION_PUBLICA=1'   class='btn btn'><h6>Volver a intentarlo </h6></a>						 </div>
			  ...
			  <div class='modal-dialog' role='document'>
				<div class='modal-content'>
				  <div class='modal-header'>
					...
					<h2 class='modal-title' id='exampleModalLabel'>Error al ingresar a Control </h2>
				  </div>
				  <div class='modal-body'>
						<div class=' alert alert-warning  formulario-acceso-clientes' role='alert'>
						  <h2 class='alert-heading  text-center'>
						  ...
						  <h1>
						  <div class='text-center'>
                            <a type='button' style='background-color: #a8ad00!important;' href='https://app.aoacolombia.com/intranet/control.php?Acc=ingreso_sistema&SESION_PUBLICA=1'   class='btn-lg btn'><h6>Volver a intentarlo </h6></a>						 </div>
						</div>
				
				  </div>
				  <div class='modal-footer'>
					<button type='button' class='btn btn-secondary' data-dismiss='modal'>Cancelar  </button>
					<a type='button' style='background-color: #a8ad00!important;' href='https://app.aoacolombia.com/intranet/control.php?Acc=ingreso_sistema&SESION_PUBLICA=1'   class='btn btn'><h6>Volver a intentarlo </h6></a>
				  </div>
				</div>
			  </div>
			</div>
...
<head>
  <meta http-equiv='Content-Type' content='text/html; charset=utf-8'/>
		...
		<!--// WORDPRESS HEAD HOOK //-->
		<title>Intranet AOA Colombia </title>
		<link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css'>
...
<div class='inner-page-wrap has-no-sidebar clearfix'>
	...
	<div class='clearfix ' id='79'>
				...
				<h1 style='text-align:center' class='texto-bold-titulo-1'>Selecciona un perfil de Control </h1>
