<?php
	...
	function opciones_1(Dato)
			{
			if(Dato==666) { modal2('http://app.aoacolombia.com/Administrativo/administracion_zcalidad.php',0,0,600,900,'win3'); document.getElementById('sp_1').style.visibility='hidden'; return true;}
					
				}
				function opciones_2(Dato)
			{
			if(Dato==611) { modal2('zcallcenter2.php',0,0,0,0,'destino'); document.getElementById('sp_2').style.visibility='hidden'; return true;}
					
				}
				function opciones_3(Dato)
			{
			if(Dato==593) { modal2('zsiniestro.php',0,0,0,0,'win5'); document.getElementById('sp_3').style.visibility='hidden'; return true;}
					if(Dato==554) { modal2('zpqr.php',0,0,800,800,'_blank'); document.getElementById('sp_3').style.visibility='hidden'; return true;}
					if(Dato==709) { modal2('zmonitor_operativo_aseguradora.php',0,0,700,1000,'destino'); document.getElementById('sp_3').style.visibility='hidden'; return true;}
			...
			<tr><td align='center' style='font-size:14px'><b>CALIDAD</b></td></tr><tr ><td class='menuprincipal' onclick='opciones_1(666);'>SISTEMA DE GESTION DE CALIDAD</td></tr></tr></table></span><center><b style='font-size:13px'><a onclick="document.getElementById('sp_1').style.visibility='visible';">CALIDAD</a></b></center></td><td width='150' 
			...
			<table bgcolor='ddeeee' border=0 cellspacing=1 width='150' cellpadding=0>
			<tr><td align='center' style='font-size:14px'><b>CALLCENTER</b></td></tr><tr ><td class='menuprincipal' onclick='opciones_2(611);'>Call Center 2</td></tr></tr></table></span><center><b style='font-size:13px'><a onclick="document.getElementById('sp_2').style.visibility='visible';">CALLCENTER</a></b></center></td><td width='150' 
			...
			<table bgcolor='ddeeee' border=0 cellspacing=1 width='150' cellpadding=0>
			<tr><td align='center' style='font-size:14px'><b>MENU PRINCIPAL</b></td></tr><tr ><td class='menuprincipal' onclick='opciones_3(593);'>Buscar Siniestro</td></tr><tr ><td class='menuprincipal' onclick='opciones_3(554);'>CAPTURA - PQR</td></tr><tr ><td class='menuprincipal' onclick='opciones_3(709);'>Monitor x Aseguradora</td></tr></tr></table></span><center><b style='font-size:13px'><a onclick="document.getElementById('sp_3').style.visibility='visible';">MENU PRINCIPAL</a></b></center></td></tr></table><table width='100%' cellspacing=0 cellpaddig=0><tr><td width='100px' valign='top'><a class='info' style='cursor:pointer;' onclick="modal2('http://app.aoacolombia.com/Administrativo/administracion_zcalidad.php',0,0,600,900,'win3'); ">
				...
				<a class='info' style='cursor:pointer;' onclick="modal2('zcallcenter2.php',0,0,0,0,'destino'); ">
				<img src='imagenes/000/610/dicono_f_callnew.png' width='48' border='0'>
				<span style='width:300px'>Call Center 2<br></span></a>
