<?php
	...
	function opciones_1(Dato)
			{
			if(Dato==699) { modal2('marcoindex.php?Acc=abre_tabla&Num_Tabla=699',0,0,800,1000,'destino'); document.getElementById('sp_1').style.visibility='hidden'; return true;}
			...
			<tr><td align='center' style='font-size:14px'><b>USUARIOS</b></td></tr><tr ><td class='menuprincipal' onclick='opciones_1(699);'>Usuario Call Center</td></tr></tr></table></span><center><b style='font-size:13px'><a onclick="document.getElementById('sp_1').style.visibility='visible';">USUARIOS</a></b></center></td></tr></table><table width='100%' cellspacing=0 cellpaddig=0><tr><td width='100px' valign='top'><a class='info' style='cursor:pointer;' onclick="modal2('marcoindex.php?Acc=abre_tabla&Num_Tabla=699',0,0,800,1000,'destino'); ">
				<img src='imagenes/000/699/dicono_f_call_inicio.png' width='48' border='0'>
				<span style='width:300px'>Usuario Call Center<br></span></a>
				</td><td>
