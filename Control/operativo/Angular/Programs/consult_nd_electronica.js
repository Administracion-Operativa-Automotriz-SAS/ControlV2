...
app.controller("ConsultController", function ($scope,$http,$filter) {
	...
	$scope.init = function(){
		let request = $http.post("/Control/operativo/controllers/Fact_electronica_angular/Fact_electronica_angular.php",{acc:"get_nd_electronica",nota_credito:findGetParameter("id")});
