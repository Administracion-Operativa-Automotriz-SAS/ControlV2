<?php
	...
	function opciones_1(Dato)
			{
			if(Dato==769) { modal2('marcoindex.php?Acc=abre_tabla&Num_Tabla=769',0,0,800,1000,'destino'); document.getElementById('sp_1').style.visibility='hidden'; return true;}
					
				}
				function opciones_2(Dato)
			{
			if(Dato==770) { modal2('zcontrol_operativo3.php',0,0,800,800,'win'); document.getElementById('sp_2').style.visibility='hidden'; return true;}
					if(Dato==762) { modal('marcoindex.php?Acc=abre_movimiento&Num_Tabla=762',0,0,900,1000,'destino'); document.getElementById('sp_2').style.visibility='hidden'; return true;}
					if(Dato==764) { modal('marcoindex.php?Acc=abre_movimiento&Num_Tabla=764',0,0,800,1000,'destino'); document.getElementById('sp_2').style.visibility='hidden'; return true;}
			...
			<tr><td align='center' style='font-size:14px'><b>FLOTAS</b></td></tr><tr ><td class='menuprincipal' onclick='opciones_1(769);'>[CFG] Alerta x Vehiculo</td></tr></tr></table></span><center><b style='font-size:13px'><a onclick="document.getElementById('sp_1').style.visibility='visible';">FLOTAS</a></b></center></td></tr><tr><td width='150' 
			...
			<table bgcolor='ddeeee' border=0 cellspacing=1 width='150' cellpadding=0>
			<tr><td align='center' style='font-size:14px'><b>OPERATIVO</b></td></tr><tr ><td class='menuprincipal' onclick='opciones_2(770);'>Control Operativo</td></tr><tr ><td class='menuprincipal' onclick='opciones_2(762);'>SEGUROS</td></tr><tr ><td class='menuprincipal' onclick='opciones_2(764);'>VEHICULOS</td></tr></tr></table></span><center><b style='font-size:13px'><a onclick="document.getElementById('sp_2').style.visibility='visible';">OPERATIVO</a></b></center></td></tr><tr></tr></table><table width='100%' cellspacing=0 cellpaddig=0><tr><td width='100px' valign='top'><a class='info' style='cursor:pointer;' onclick="modal2('zcontrol_operativo3.php',0,0,800,800,'win'); ">
				<img src='img/control.png' width='48' border='0'>
				<span style='width:300px'>Control Operativo<br></span></a>
				<a class='info' style='cursor:pointer;' onclick="modal('marcoindex.php?Acc=abre_movimiento&Num_Tabla=762',0,0,900,1000,'destino'); ">
				<img src='imagenes/000/758/dicono_f_images.jpg' width='48' border='0'>
				<span style='width:300px'>SEGUROS<br></span></a>
				<a class='info' style='cursor:pointer;' onclick="modal('marcoindex.php?Acc=abre_movimiento&Num_Tabla=764',0,0,800,1000,'destino'); ">
