<?php
	...
	function opciones_1(Dato)
			{
			if(Dato==697) { modal2('zconsulta_siniestro1_1.php',0,0,800,1000,'win'); document.getElementById('sp_1').style.visibility='hidden'; return true;}
			...
			<tr><td align='center' style='font-size:14px'><b>MENU PRINCIPAL</b></td></tr><tr ><td class='menuprincipal' onclick='opciones_1(697);'>CONSULTA SINIESTROS</td></tr></tr></table></span><center><b style='font-size:13px'><a onclick="document.getElementById('sp_1').style.visibility='visible';">MENU PRINCIPAL</a></b></center></td></tr></table><table width='100%' cellspacing=0 cellpaddig=0><tr><td width='100px' valign='top'><a class='info' style='cursor:pointer;' onclick="modal2('zconsulta_siniestro1_1.php',0,0,800,1000,'win'); ">
