...
class json_nota_credito
{
	function __construct()
	{	
		
		
		$this->nota_credito_json = '{
	"fe:CreditNote": {
		...
		$this->nc_object = json_decode($this->nota_credito_json);
		$this->fe_CreditNote = "fe:CreditNote";
		...
		$this->cbc_CreditedQuantity = "cbc:CreditedQuantity";
		...
		$this->cac_CreditNoteLine = "cac:CreditNoteLine";
	...
	{	
		...
		$this->nc_object->{$this->fe_CreditNote}->{$this->ext_UBLExtensions}->{$this->ext_UBLExtension}->{$this->ext_ExtensionContent}->{$this->PtesaExtensions_PtesaExtensions}->InformacionDeAdquiriente->Informacion[0]->Valor = $EmailAdq;
		$this->nc_object->{$this->fe_CreditNote}->{$this->ext_UBLExtensions}->{$this->ext_UBLExtension}->{$this->ext_ExtensionContent}->{$this->PtesaExtensions_PtesaExtensions}->InformacionDeAdquiriente->Informacion[2]->Valor = $AplicaRUT;
		$this->nc_object->{$this->fe_CreditNote}->{$this->ext_UBLExtensions}->{$this->ext_UBLExtension}->{$this->ext_ExtensionContent}->{$this->PtesaExtensions_PtesaExtensions}->InformacionDeAdquiriente->Informacion[2]->Valor = $AplicaCC;
	...
	public function set_InformacionDeDocumento($FechaVenc="2018/07/06",$VlrEnLetras="SON: TREINTA Y CINCO MIL PESOS MCTE CON CERO CENTAVOS",$OrdCompra="N.A",$Resolucion_factura="Res. de fact")
	{
		...
		$this->nc_object->{$this->fe_CreditNote}->{$this->ext_UBLExtensions}->{$this->ext_UBLExtension}->{$this->ext_ExtensionContent}->{$this->PtesaExtensions_PtesaExtensions}->InformacionDeDocumento->Informacion[0]->Valor = $FechaVenc;
		$this->nc_object->{$this->fe_CreditNote}->{$this->ext_UBLExtensions}->{$this->ext_UBLExtension}->{$this->ext_ExtensionContent}->{$this->PtesaExtensions_PtesaExtensions}->InformacionDeDocumento->Informacion[1]->Valor = $Resolucion_factura;
		$this->nc_object->{$this->fe_CreditNote}->{$this->ext_UBLExtensions}->{$this->ext_UBLExtension}->{$this->ext_ExtensionContent}->{$this->PtesaExtensions_PtesaExtensions}->InformacionDeDocumento->Informacion[3]->Valor = $VlrEnLetras;
		$this->nc_object->{$this->fe_CreditNote}->{$this->ext_UBLExtensions}->{$this->ext_UBLExtension}->{$this->ext_ExtensionContent}->{$this->PtesaExtensions_PtesaExtensions}->InformacionDeDocumento->Informacion[4]->Valor = $OrdCompra;			
	
	}
	
	public function set_Doc_anulacion($fact_to_null = "FE01")
	{
		$this->nc_object->{$this->fe_CreditNote}->{$this->cac_BillingReference}->{$this->cac_InvoiceDocumentReference}->{$this->cbc_ID}->{$this->text} = $fact_to_null;
	}
	
	public function set_Consecutive($consecutive = "NC1")
	{
		$this->nc_object->{$this->fe_CreditNote}->{$this->cbc_ID} = $consecutive;
		
		$this->nc_object->{$this->fe_CreditNote}->{$this->cbc_IssueDate} = date('Y-m-d'); 
		
		$this->nc_object->{$this->fe_CreditNote}->{$this->cbc_IssueTime} = date('H:i:s');
	}
	...
	public function set_Info_Cliente($FirstName ="SERGIO", $FamilyName = "CASTILLO" ,$Deparment = "Bogota D.C.", $neighborhood = "CHICO", $City = "Bogotá D.C.",$Address = "Cra X # XX - XX",$Telephone = "(+571) 88 88 888",$PartyIdentification="12345678",$RegistrationName="Pepito SAS")
	{
		...
		$this->nc_object->{$this->fe_CreditNote}->{$this->fe_AccountingCustomerParty}->{$this->fe_Party}->{$this->cac_PartyName}->{$this->cbc_Name} =  $customer_name;
		$this->nc_object->{$this->fe_CreditNote}->{$this->fe_AccountingCustomerParty}->{$this->fe_Party}->{$this->fe_PhysicalLocation}->{$this->fe_Address}->{$this->cbc_Department} = $Deparment;
		$this->nc_object->{$this->fe_CreditNote}->{$this->fe_AccountingCustomerParty}->{$this->fe_Party}->{$this->fe_PhysicalLocation}->{$this->fe_Address}->{$this->cbc_CitySubdivisionName} = $neighborhood;
		$this->nc_object->{$this->fe_CreditNote}->{$this->fe_AccountingCustomerParty}->{$this->fe_Party}->{$this->fe_PhysicalLocation}->{$this->fe_Address}->{$this->cbc_CityName} = $City; 
		$this->nc_object->{$this->fe_CreditNote}->{$this->fe_AccountingCustomerParty}->{$this->fe_Party}->{$this->fe_PhysicalLocation}->{$this->fe_Address}->{$this->cac_AddressLine}->{$this->cbc_Line} = $Address;
		$this->nc_object->{$this->fe_CreditNote}->{$this->fe_AccountingCustomerParty}->{$this->fe_Party}->{$this->cac_Contact}->{$this->cbc_Telephone} = $Telephone;
		$this->nc_object->{$this->fe_CreditNote}->{$this->fe_AccountingCustomerParty}->{$this->fe_Party}->{$this->fe_Person}->{$this->cbc_FirstName} = $FirstName;
		$this->nc_object->{$this->fe_CreditNote}->{$this->fe_AccountingCustomerParty}->{$this->fe_Party}->{$this->fe_Person}->{$this->cbc_FamilyName} = $FamilyName;		
		$this->nc_object->{$this->fe_CreditNote}->{$this->fe_AccountingCustomerParty}->{$this->fe_Party}->{$this->cac_PartyIdentification}->{$this->cbc_ID}->{$this->innerText} = $PartyIdentification;		
		$this->nc_object->{$this->fe_CreditNote}->{$this->fe_AccountingCustomerParty}->{$this->fe_Party}->{$this->fe_PartyLegalEntity}->{$this->cbc_RegistrationName} = $RegistrationName;
	...
	public function set_TaxTotal($TaxAmount="40000",$TaxableAmount="50000")
	{
		...
		$this->nc_object->{$this->fe_CreditNote}->{$this->fe_TaxTotal}->{$this->cbc_TaxAmount}->{$this->innerText} = number_format((float)$TaxAmount, 2, '.', '');
		$this->nc_object->{$this->fe_CreditNote}->{$this->fe_TaxTotal}->{$this->fe_TaxSubtotal}->{$this->cbc_TaxableAmount}->{$this->innerText} = number_format((float)$TaxableAmount, 2, '.', '');
		$this->nc_object->{$this->fe_CreditNote}->{$this->fe_TaxTotal}->{$this->fe_TaxSubtotal}->{$this->cbc_TaxAmount}->{$this->innerText} = number_format((float)$TaxAmount, 2, '.', ''); 
	}
	...
	public function set_LegalMonetaryTotal($LineExtensionAmount="10000",$TaxExclusiveAmount="20000",$AllowanceTotalAmount="10000")
	{
		...
		$this->nc_object->{$this->fe_CreditNote}->{$this->fe_LegalMonetaryTotal}->{$this->cbc_LineExtensionAmount}->{$this->innerText} = number_format((float)$LineExtensionAmount, 2, '.', '');
		$this->nc_object->{$this->fe_CreditNote}->{$this->fe_LegalMonetaryTotal}->{$this->cbc_TaxExclusiveAmount}->{$this->innerText} = number_format((float)$TaxExclusiveAmount, 2, '.', ''); 
		$this->nc_object->{$this->fe_CreditNote}->{$this->fe_LegalMonetaryTotal}->{$this->cbc_AllowanceTotalAmount}->{$this->innerText} = number_format((float)$AllowanceTotalAmount, 2, '.', '');
		$this->nc_object->{$this->fe_CreditNote}->{$this->fe_LegalMonetaryTotal}->{$this->cbc_PayableAmount}->{$this->innerText} = number_format((float)(($LineExtensionAmount + $TaxExclusiveAmount)-$AllowanceTotalAmount), 2, '.', '');
		
	}
	
	
	public function set_ncItems($array_of_items=array(array("cantidad"=>2,"valor"=>"3500","descripcion"=>"item no.1"),array("cantidad"=>3,"valor"=>"2000","descripcion"=>"item no.2")))
	{	
		...
		foreach($array_of_items as $item)
		{
			...
			$new_item = json_decode($this->NC_item_string);
			
			$new_item->{$this->cbc_ID} = $count;

			$new_item->{$this->cbc_CreditedQuantity} = $item["cantidad"];	
		...
		$this->nc_object->{$this->fe_CreditNote}->{$this->cac_CreditNoteLine} = $array_objects;
	}
