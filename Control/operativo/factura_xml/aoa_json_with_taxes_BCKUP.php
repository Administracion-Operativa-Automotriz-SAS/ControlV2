...
class json_fact_electronica_taxes
{
	...
	{		
		...
		$this->json_object->{$this->fe_Invoice_key}->{$this->UBLExtensions_key}->{$this->UBLExtension_key}->{$this->ExtensionContent_key}->{$this->PtesaExtensions_key}->InformacionDeDocumento->Informacion[5]->Valor = $Observaciones;	
	...
	public function set_factItems($array_of_items=array(array("cantidad"=>2,"valor"=>"35000.00","descripcion"=>"item no.1","valor_iva"=>"2520.00","iva_perc"=>"19.00"),array("cantidad"=>3,"valor"=>"20000","descripcion"=>"item no.2","valor_iva"=>"0.00","iva_perc"=>"0.00")))
	{	
