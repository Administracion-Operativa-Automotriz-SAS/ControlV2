...
include($_SERVER["DOCUMENT_ROOT"]."/Control/operativo/factura_xml/jSon_with_takes_NUEVO3.php");
...
class factura_electronica
{
	...
	public function generate_xml_with_taxes($idfac,$consecutive)
	{
		...
		"ciudad_departamento" => $ciudad->departamento, "cliente_barrio" => $cliente->barrio, "ciudad_nombre" =>$ciudad->nombre ,"cliente_direccion" => $cliente->direccion,
