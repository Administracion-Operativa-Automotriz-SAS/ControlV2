...
class json_fact_electronica_taxes{
	...
	public function resolucionFactura($resolucionNumero = '76786',$resolucionFecha = '2019-01-19',$dateSumYear = '2050-01-19',$prefijo='FE',$consecutivoInic= '1',$consecutivoFinal='2000'){
		...
		$this->json_object->XMLPtesa->Documentos->Documento->FacturaElectronica->Resolucion->NumeroAutorizacion = 18763002872050;
		
		$this->json_object->XMLPtesa->Documentos->Documento->FacturaElectronica->Resolucion->FechaInicio = '2019-12-20';
		
		
		$this->json_object->XMLPtesa->Documentos->Documento->FacturaElectronica->Resolucion->FechaFin = '2021-12-20';
		...
		$this->json_object->XMLPtesa->Documentos->Documento->FacturaElectronica->Resolucion->Hasta = 20000;
	...
	public function set_Extenciones($array_of_items=array(array("cantidad"=>2,"valor"=>"35000.00","descripcion"=>"item no.1","valor_iva"=>"2520.00","iva_perc"=>"19.00","identificador_tributo"=>"01","nombre_tributo"=>"IVA"),
		...
		foreach($array_extenciones as $extencion){
			...
			$extenciones7->Extension->Valor = utf8_encode("El incuplimiento de pago de esta factura causa interes de mora,a la tase maxima legal permitida por la ley.");
