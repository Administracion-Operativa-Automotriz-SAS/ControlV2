...
.closebtn:hover {
  color: black;
		...
		<form action='zcitaszDiv.php' target='_self' method='POST' name='forma' id='forma'>
			 ...
			 <h3  style='color:#34b233 '> El horario de atención es de $Oficina->hora_inicial_festivo hasta $Oficina->hora_final_festivo <h3> 
			 Hora de Devolución : ".pinta_hora('forma','Hdevol',$Oficina->hora_inicial_festivo)." $diaD 
			...
			continúe con la impresión del acta sin hacer ninguna modificación. <br><br>Gracias.</b>
				  ...
				  $fecha_mas_dia  = date('Y-m-d',strtotime($Fec_entrega."+ 1 days")); 
				   ...
				   echo "<body><script language='javascript'>centrar(700,500);</script>
		<form action='zcitaszDiv.php' target='_self' method='POST' name='forma' id='forma'>
			Fecha de Devolución: ".pinta_fc('forma','Fdevol',date('Y-m-d',strtotime($fecha_mas_dia)))."
			 <h3  style='color:#34b233 '> El horario de atención es de $Oficina->hora_inicial_festivo hasta $Oficina->hora_final_festivo <h3> 
			 Hora de Devolución : ".pinta_hora('forma','Hdevol',$Oficina->hora_inicial_festivo)." $diaD 
			<input type='submit' name='continuar' id='continuar' value=' IMPRIMIR '>
			<input type='hidden' name='Acc' value='imprimir_acta'>
		...
		<form action='zcitaszDiv.php' target='_self' method='POST' name='forma' id='forma'>
			 ...
			 <h3  style='color:#34b233 '> El horario de atención es de $Oficina->hora_inicial_sabado hasta $Oficina->hora_final_sabado <h3> 
			 Hora de Devolución : ".pinta_hora('forma','Hdevol',$Oficina->hora_inicial_sabado)." $diaD 
			<input type='submit' name='continuar' id='continuar' value=' IMPRIMIR '>
			<input type='hidden' name='Acc' value='imprimir_acta'>
			<input type='hidden' name='idc' value='$idc'><br><br>
			<b style='font-size:16px'>ESTIMADO (A) USUARIO (A) ".$_SESSION['Nombre']." Tenga en cuenta que si en el momento de la devolución del automovil hay restricción
		...
		<form action='zcitaszDiv.php' target='_self' method='POST' name='forma' id='forma'>
			 ...
			 <h3  style='color:#34b233 '> El horario de atención es de $Oficina->hora_inicial hasta $Oficina->hora_final <h3> 
			 Hora de Devolución : ".pinta_hora('forma','Hdevol',$Oficina->hora_inicial)." $diaD 
			<input type='submit' name='continuar' id='continuar' value=' IMPRIMIR '>
			<input type='hidden' name='Acc' value='imprimir_acta'>
			<input type='hidden' name='idc' value='$idc'><br><br>
			<b style='font-size:16px'>ESTIMADO (A) USUARIO (A) ".$_SESSION['Nombre']." Tenga en cuenta que si en el momento de la devolución del automovil hay restricción
		   ...
		   if(!$festivos->esFestivo(date('d', $fecha_mas_dia), date('m',$fecha_mas_dia))){
			 ...
			 if($Oficina->hora_inicial || $Oficina->hora_final ){
				...
				<form action='zcitaszDiv.php' target='_self' method='POST' name='forma' id='forma'>
					...
					<h5  style='color:#34b233 '> El horario de atención es de $Oficina->hora_inicial hasta $Oficina->hora_final <h5> 
					 Hora de Devolución : ".pinta_hora('forma','Hdevol',$Oficina->hora_inicial)." $diaD 
					<input type='submit' name='continuar' id='continuar' value=' IMPRIMIR '>
					<input type='hidden' name='Acc' value='imprimir_acta'>
					<input type='hidden' name='idc' value='$idc'><br><br>
		...
		<form action='zcitaszDiv.php' target='_self' method='POST' name='forma' id='forma'>
			 ...
			 <h3  style='color:#34b233 '> El horario de atención es de $Oficina->hora_inicial_domingo hasta $Oficina->hora_final_sabado <h3> 
			 Hora de Devolución : ".pinta_hora('forma','Hdevol',$Oficina->hora_final_sabado)." $diaD 
			<input type='submit' name='continuar' id='continuar' value=' IMPRIMIR '>
			<input type='hidden' name='Acc' value='imprimir_acta'>
			<input type='hidden' name='idc' value='$idc'><br><br>
			<b style='font-size:16px'>ESTIMADO (A) USUARIO (A) ".$_SESSION['Nombre']." Tenga en cuenta que si en el momento de la devolución del automovil hay restricción
