...
class soap_transport_http extends nusoap_base {
	...
	* @access   private
	*/
	function connect($connection_timeout=200,$response_timeout=200){
...
//		}
	...
	* @access   public
	*/
	function send($data, $timeout=200, $response_timeout=200, $cookies=NULL) {
	...
	* @deprecated
	*/
	function sendHTTPS($data, $timeout=200, $response_timeout=200, $cookies) {
...
class wsdl extends nusoap_base {
     ...
     * @access public 
     */
    function wsdl($wsdl = '',$proxyhost=false,$proxyport=false,$proxyusername=false,$proxypassword=false,$timeout=200,$response_timeout=200,$curl_options=null,$use_curl=false){
		parent::nusoap_base();
...
class nusoap_client extends nusoap_base  {
	...
	var $timeout = 200;				// HTTP connection timeout
	...
	* @access   public
	*/
	function nusoap_client($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 200, $response_timeout = 200){
		parent::nusoap_base();
	...
	*/
	function call($operation,$params=array(),$namespace='http://tempuri.org',$soapAction='',$headers=false,$rpcParams=null,$style='rpc',$use='encoded'){
		...
		var_dump($this->getHTTPBody($soapmsg));
		var_dump($soapAction);
		var_dump($this->timeout);
		var_dump($this->response_timeout);
	...
	* @access   private
	*/
	function send($msg, $soapaction = '', $timeout=200, $response_timeout=200) {
		$this->checkCookies();
		// detect transport
		switch(true){
			// http(s)
