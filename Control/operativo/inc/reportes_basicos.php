...
function rep_basicos()
{
	...
	<form action='reportes.php' method='post' target='_self' name='forma' id='forma'>
		<table>
			...
			<tr><td>Nombre del informe</td><td><input type='text' name='nombre' value='$R->nombre' size='80' maxlength='100'></td></tr>
...
function actualiza_basicos()
{
	...
	global $versql,$construye,$distintos,$gen_csv,$incluir_id,$etiqueta_id,$csv_contitulos,$salida_exel,$propiedades_tr,
	$tit_add,$vancho,$valto,$clase,$usuarios,$csv_nombre,$separador_csv,$ancho,$nombre,$borde,
	$salida_exel_nombre,$idreporte;
