function re_sesion()
{
  if(confirm('Su sesion ha expirado. Desea recuperar la sesion?'))
  {
      ...
      doc.write("<tr><td>Password</td><td><input type='password' name='Password' onKeyPress='bloqueo_mayusculas(event)'><br><div id='bloqueomayusculas' style='visibility:hidden'><b>El bloqueo de mayúsculas está activado</b></div></td></tr>");
