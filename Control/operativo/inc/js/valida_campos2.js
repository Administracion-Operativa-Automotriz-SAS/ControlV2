		...
		for(i=0;i<Arreglo_campos.length;i++)
		{
			...
			switch(Arreglo_campo[1])
			{
				...
				case 'f':
					...
					break;
				default:
					var campo= "if(document."+forma+"."+Arreglo_campo[0]+") {if(document."+forma+"."+Arreglo_campo[0]+".value=='') {document."+forma+"."+Arreglo_campo[0]+"fallos=true;}}";/*Hay que definir variable ".style.backgroundColor='red';fallon=true;}}";*/
					eval(campo);
