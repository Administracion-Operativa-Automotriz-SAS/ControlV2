...
function presenta_caso()
{
	...
	if($D=qo("select * from call2cola2 where id='$id'"))
	{
		...
		echo "<br><br>
			...
			require($Ase->archivo_contrato_php);
			echo "<br><br>
...
function acepta_terminos()
{
	...
	if($D=qo("select * from call2cola2 where id='$id'"))
	{
		...
		lo contactará el Área de Adjudicaciones para informarle la fecha, hora y lugar de la cita donde se le entregará el vehículo asignado.<br><br>
