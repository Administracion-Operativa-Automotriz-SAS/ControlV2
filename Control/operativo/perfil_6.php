<?php
	...
	function opciones_1(Dato)
			{
			if(Dato==668) { modal2('http://app.aoacolombia.com/Administrativo/administracion_zcalidad.php',0,0,600,900,'win3'); document.getElementById('sp_1').style.visibility='hidden'; return true;}
					
				}
				function opciones_2(Dato)
			{
			if(Dato==230) { modal2('marcoindex.php?Acc=abre_tabla&Num_Tabla=230',0,0,800,1000,'destino'); document.getElementById('sp_2').style.visibility='hidden'; return true;}
					if(Dato==515) { modal2('zcartera.php',0,0,750,1000,'destino'); document.getElementById('sp_2').style.visibility='hidden'; return true;}
					if(Dato==481) { modal2('marcoindex.php?Acc=abre_tabla&Num_Tabla=481',0,0,800,1000,'destino'); document.getElementById('sp_2').style.visibility='hidden'; return true;}
					if(Dato==438) { modal2('marcoindex.php?Acc=abre_tabla&Num_Tabla=438',0,0,800,1000,'destino'); document.getElementById('sp_2').style.visibility='hidden'; return true;}
					if(Dato==233) { modal2('marcoindex.php?Acc=abre_tabla&Num_Tabla=233',0,0,800,1000,'destino'); document.getElementById('sp_2').style.visibility='hidden'; return true;}
					
				}
				function opciones_3(Dato)
			{
			if(Dato==597) { modal2('zsiniestro.php',0,0,0,0,'win5'); document.getElementById('sp_3').style.visibility='hidden'; return true;}
					if(Dato==557) { modal2('zpqr.php',0,0,800,800,'_blank'); document.getElementById('sp_3').style.visibility='hidden'; return true;}
					if(Dato==354) { modal2('https://consultas.transitobogota.gov.co:8010/publico/index3.php',0,0,700,900,'win3'); document.getElementById('sp_3').style.visibility='hidden'; return true;}
					if(Dato==268) { modal2('marcoindex.php?Acc=abre_tabla&Num_Tabla=268',0,0,800,1000,'destino'); document.getElementById('sp_3').style.visibility='hidden'; return true;}
					if(Dato==247) { modal2('marcoindex.php?Acc=abre_tabla&Num_Tabla=247',0,0,800,1000,'destino'); document.getElementById('sp_3').style.visibility='hidden'; return true;}
					if(Dato==269) { modal2('zcontrol_operativo3.php',0,0,700,900,'win2'); document.getElementById('sp_3').style.visibility='hidden'; return true;}
					if(Dato==267) { modal('marcoindex.php?Acc=abre_movimiento&Num_Tabla=267',0,0,800,1000,'destino'); document.getElementById('sp_3').style.visibility='hidden'; return true;}
					
				}
				function opciones_4(Dato)
			{
			if(Dato==654) { modal2('marcoindex.php?Acc=abre_tabla&Num_Tabla=654',0,0,800,1000,'destino'); document.getElementById('sp_4').style.visibility='hidden'; return true;}
			...
			<tr><td align='center' style='font-size:14px'><b>CALIDAD</b></td></tr><tr ><td class='menuprincipal' onclick='opciones_1(668);'>SISTEMA DE GESTION DE CALIDAD</td></tr></tr></table></span><center><b style='font-size:13px'><a onclick="document.getElementById('sp_1').style.visibility='visible';">CALIDAD</a></b></center></td><td width='150' 
			...
			<table bgcolor='ddeeee' border=0 cellspacing=1 width='150' cellpadding=0>
			<tr><td align='center' style='font-size:14px'><b>CARTERA</b></td></tr><tr ><td class='menuprincipal' onclick='opciones_2(230);'>Conceptos Facturacion</td></tr><tr ><td class='menuprincipal' onclick='opciones_2(515);'>Control de Cartera</td></tr><tr ><td class='menuprincipal' onclick='opciones_2(481);'>Recibo de Caja</td></tr><tr ><td class='menuprincipal' onclick='opciones_2(438);'>Solicitud de Facturacion Pendiente</td></tr><tr ><td class='menuprincipal' onclick='opciones_2(233);'>Tarifas</td></tr></tr></table></span><center><b style='font-size:13px'><a onclick="document.getElementById('sp_2').style.visibility='visible';">CARTERA</a></b></center></td><td width='150' 
			...
			<table bgcolor='ddeeee' border=0 cellspacing=1 width='150' cellpadding=0>
			<tr><td align='center' style='font-size:14px'><b>MENU PRINCIPAL</b></td></tr><tr ><td class='menuprincipal' onclick='opciones_3(597);'>Buscar Siniestro</td></tr><tr ><td class='menuprincipal' onclick='opciones_3(557);'>CAPTURA - PQR</td></tr><tr ><td class='menuprincipal' onclick='opciones_3(354);'>Consulta Comparendos BOGOTA</td></tr><tr ><td class='menuprincipal' onclick='opciones_3(268);'>HISTORICO</td></tr><tr ><td class='menuprincipal' onclick='opciones_3(247);'>SINIESTROS</td></tr><tr ><td class='menuprincipal' onclick='opciones_3(269);'>TABLA DE CONTROL OPERATIVO</td></tr><tr ><td class='menuprincipal' onclick='opciones_3(267);'>VEHICULOS</td></tr></tr></table></span><center><b style='font-size:13px'><a onclick="document.getElementById('sp_3').style.visibility='visible';">MENU PRINCIPAL</a></b></center></td><td width='150' 
			...
			<table bgcolor='ddeeee' border=0 cellspacing=1 width='150' cellpadding=0>
			<tr><td align='center' style='font-size:14px'><b>OPERATIVO</b></td></tr><tr ><td class='menuprincipal' onclick='opciones_4(654);'>Comparendos</td></tr></tr></table></span><center><b style='font-size:13px'><a onclick="document.getElementById('sp_4').style.visibility='visible';">OPERATIVO</a></b></center></td></tr></table><table width='100%' cellspacing=0 cellpaddig=0><tr><td width='100px' valign='top'><a class='info' style='cursor:pointer;' onclick="modal2('zcitas.php',0,0,0,0,'destino'); ">
				<img src='imagenes/182/anotacion.png' width='48' border='0'>
				<span style='width:300px'>Citas del dia<br></span></a>
				<a class='info' style='cursor:pointer;' onclick="modal2('https://consultas.transitobogota.gov.co:8010/publico/index3.php',0,0,700,800,'win2'); ">
				...
				<a class='info' style='cursor:pointer;' onclick="modal2('marcoindex.php?Acc=abre_tabla&Num_Tabla=438',0,0,800,1000,'destino'); ">
				<img src='imagenes/000/438/1060.jpg' width='48' border='0'>
				<span style='width:300px'>Solicitud de Facturacion Pendiente<br></span></a>
				...
				<a class='info' style='cursor:pointer;' onclick="modal2('marcoindex.php?Acc=abre_tabla&Num_Tabla=247',0,0,800,1000,'destino'); ">
				...
				<span style='width:300px'>TABLA DE CONTROL OPERATIVO<br></span></a>
				<a class='info' style='cursor:pointer;' onclick="modal('marcoindex.php?Acc=abre_movimiento&Num_Tabla=267',0,0,800,1000,'destino'); ">
