	...
	<meta charset='UTF-8' />	
                ...
                <div class='text-center'></div>
				 ...
				 <div class='text-center'>
                  <a type='button' style='background-color: #a8ad00!important;' href='../../intranet/control.php?Acc=ingreso_sistema&SESION_PUBLICA=1'   class='btn btn'><h6>Volver a intentarlo </h6></a>						 </div>
				...
				<div class='modal-content'>
				  ...
				  <div class='modal-body'>
						<div class=' alert alert-warning  formulario-acceso-clientes' role='alert'>
						  ...
						  <img src='https://www.creativografico.dev/webAOA/wp-content/uploads/2020/02/tiempo-prestamo-vehiculo-reemplazo-aoacolombia.png'>
						  <br>
						  </h2>
			  ...
			  <div class='modal-dialog' role='document'>
				<div class='modal-content'>
				  <div class='modal-header'>
					...
					<h2 class='modal-title' id='exampleModalLabel'>Usuario clave asigna </h2>
				  </div>
				  <div class='modal-body'>
						<div class=' alert alert-warning  formulario-acceso-clientes' role='alert'>
						  <h2 class='alert-heading  text-center'>
						  ...
						  <h1  class='text-center'>
						 Tiene una clave asigna. A continuación se le solicitará una nueva contraseña.
						  <h1>
						  <div class='text-center'>
                            <a type='button' style='background-color: #a8ad00!important;' href='../intranet/admin.php?Acc=ingreso_sistema&SESION_PUBLICA=1'   class='btn btn'><h6>Volver a intentarlo </h6></a>						 </div>
						</div>
