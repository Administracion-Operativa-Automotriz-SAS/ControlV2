...
if($Siniestros=q("select * from tmpi_tiempos"))
{
	...
	echo "<table border cellspacing='0' style='empty-cells:show'><tr><th>#</th><th>Numero</th><th>Fecha Autorización</th><th>Estado</th>
				...
				<th>Remitido</th><th>Actualización</th><th>Diferencia</th><th>Placa</th><th>Ciudad</th>";
	if($_Exel) echo "<th>Observaciones</th><th>Rango Gestión</th><th>Rango Contacto</th>";
	echo "</tr>";
	$Contador=0;
	$CantidadG=0;
	$CantidadC=0;
...
function pide_datos()
{
	...
	echo "<script language='javascript'>
		...
		<form action='zcalculo_tiempos2.php' method='post' target='IResultado' name='forma' id='forma'>
			...
			Filtra por: ".menu3("MOD","Ingreso,Ingreso;Autorizacion,Autorización",'Autorizacion',0,0," "," ")."
			Mostrar: ".menu3("MOS","todos,Todos;retencion,Solo Retención;sinretencion,Sin Retención","todos",0," "," ")."
