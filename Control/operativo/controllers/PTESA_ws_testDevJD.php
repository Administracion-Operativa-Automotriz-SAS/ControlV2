...
class PTESA_ws
{
	...
	public function registro_documento_obligatorio_test($mensajeBase64,$tipoDocumento,$numeroDocumento,$numeroDocumentoAsociado="")
	{
		...
		$requestEmission = Requests::post('https://facturaelectronicavp.ptesa.com.co/api/fe/v1/integration/emission',$headers,json_encode($data_to_send),$options);
		//var_dump($requestEmission);
	
	     sleep(50);
	     $id = $trackId->trackId;
	    $data_send_trackIds = array("trackId"=>$id);
		
		$requestTrackId = Requests::post('https://facturaelectronicavp.ptesa.com.co/api/fe/v1/integration/emission/trackId',$headers,json_encode($data_send_trackIds),$options);
	...
	public function  registro_cufe_documento_obligatorio_test($id,$mensajeBase64,$tipoDocumento,$numeroDocumento,$numeroDocumentoAsociado="")
	{
		echo $id;
		Requests::register_autoloader();
	...
	public function registro_documento_obligatorio_test25($mensajeBase64,$tipoDocumento,$numeroDocumento,$numeroDocumentoAsociado="")
	{
		...
		$requestToken = Requests::post('https://facturaelectronicavp.ptesa.com.co/api/fe/v1/security/oauth/token',
		array('content-type'=>'application/x-www-form-urlencoded'), array("username"=>"s.ospina@valps.com","password"=>"P4w5W0rT","grant_type"=>"password"));
	    ...
	    $base64  = base64_decode($mensajeBase64);
	   
		
		$no_permitidas= array ("á","é","í","ó","ú","Á","É","Í","Ó","Ú","ñ","À","Ã","Ì","Ò","Ù","Ã™","Ã ","Ã¨","Ã¬","Ã²","Ã¹","ç","Ç","Ã¢","ê","Ã®","Ã´","Ã»","Ã‚","ÃŠ","ÃŽ","Ã”","Ã›","ü","Ã¶","Ã–","Ã¯","Ã¤","«","Ò","Ã","Ã„","Ã‹");
			$permitidas= array ("a","e","i","o","u","A","E","I","O","U","n","N","A","E","I","O","U","a","e","i","o","u","c","C","a","e","i","o","u","A","E","I","O","U","u","o","O","i","a","e","U","I","A","E");
			$texto = str_replace($no_permitidas, $permitidas ,$base64);
			
	   
	   $base = base64_encode($texto);
		...
		$requestEmission = Requests::post('https://secfevalpruebas.ptesa.com.co:8443/api/fe/v1/integration/emission',$headers,json_encode($data_to_send),$options);
		//var_dump($requestEmission);

		sleep(10);
		
		$data_send_trackIds = array("trackId"=>$requestEmission->body);
		
		echo $requestEmission->body;
		
		
		$requestTrackId =
		Requests::post('https://secfevalpruebas.ptesa.com.co:8443/api/fe/v1/integration/emission/trackId',$headers,array($requestEmission->body),$options);
		//var_dump($requestTrackId);
	   ...
	   $requestDocuments_definitivo = Requests::post('https://secfevalpruebas.ptesa.com.co:8443/api/fe/v1/integration/documents',$headers,json_encode($data_send_documentos),$options);
	...
	/*En produccion 2*/
	public function registro_documento_obligatorio_test2($mensajeBase64,$tipoDocumento,$numeroDocumento,$numeroDocumentoAsociado="")
	{
	...
	/*Pruebas empoint*/
	public function registro_documento_obligatorio_test_pruebas($mensajeBase64,$tipoDocumento,$numeroDocumento,$numeroDocumentoAsociado="")
	{
		var_dump($mensajeBase64);
		Requests::register_autoloader();
