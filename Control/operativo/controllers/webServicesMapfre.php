		    ...
		    $array_num = count($val);
			  ...
			  for ($i = 1; $i < $array_num; ++$i){
					...
					if($object_already_exist->numero){
					   ...
					   $con_romo_siniestro  = "UPDATE siniestro SET cod_ramo ='$COD_RAMO' WHERE id = '$id' ";
...
//								 $placa_especial = q($sql_inse);
                                                                ...
                                                                $mapfre_vip = "UPDATE siniestro SET aseguradora ='262' WHERE id = '$id' ";
...
//								 $placa_especial = q($sql_inse);
                                                                ...
                                                                $mapfre_vip = "UPDATE siniestro SET aseguradora ='10' WHERE id = '$id' ";
						...
						if($numero_perdida == 1){
							...
							if(!$object_already_exist->perdida_total){
								...
								$sql_solicitud = "SELECT * FROM solicitud_extra where siniestro = $id ";
								...
								if($object_solicitud_extra->tipo == 'EXTENSION'){
									...
									if($object_already_exist->estado == '3'){
										...
										$sql_perdida_o = "UPDATE siniestro SET dias_servicio='$dias', perdida_total='1' WHERE id = '$id' ";
										  ...
										  if($object_already_exist->estado == '8'){
										     ...
										     $dias_s = abs($dias_disas); 
												...
												$dias = $dias_s +  $dia;
													...
													$sql_perdida_o = "UPDATE siniestro SET  perdida_total='1' WHERE id = '$id' ";
...
//								 $placa_especial = q($sql_inse);
					...
					if($COD_RAMO == 132 || $fasecolda == 'TOYOTA') {
