...
require_once($_SERVER["DOCUMENT_ROOT"]."/Control/operativo/factura_xml/factura_electronica_NUEVOdevJd.php");
...
class Fact_electronica_angular
{
	...
	{
		$sql = "select * from fact_electronica_seguimiento_pruebas where factura = ".$this->request->factura;			
