...
//require_once($_SERVER["DOCUMENT_ROOT"]."/Control/operativo/factura_xml/factura_electronica_NUEVO.php");
require_once($_SERVER["DOCUMENT_ROOT"]."/Control/operativo/factura_xml/factura_electronica_new.php");
		...
		try
		{
			...
			if(!$last_cons )
			{
				...
				{			
					...
					$register["json"] = "";
					$register["estado"] = 1;
					$register["usuario"] = 'WEBUSER'; //$_SESSION["Nombre"];
