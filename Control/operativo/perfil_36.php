<?php
	...
	function opciones_1(Dato)
			{
			if(Dato==711) { modal2('zcalculo_tiempos2.php',0,0,50,50,'_blank'); document.getElementById('sp_1').style.visibility='hidden'; return true;}
					if(Dato==508) { modal2('zconsulta_siniestro1.php',0,0,800,1000,'win'); document.getElementById('sp_1').style.visibility='hidden'; return true;}
					if(Dato==712) { modal2('zmonitor_operativo.php',0,0,700,1000,'destino'); document.getElementById('sp_1').style.visibility='hidden'; return true;}
					
				}
				function opciones_2(Dato)
			{
			if(Dato==713) { modal2('reportes2.php',0,0,0,0,'destino'); document.getElementById('sp_2').style.visibility='hidden'; return true;}
			...
			<table bgcolor='ddeeee' border=0 cellspacing=1 width='150' cellpadding=0>
			<tr><td align='center' style='font-size:14px'><b>REPORTES</b></td></tr><tr ><td class='menuprincipal' onclick='opciones_2(713);'>Reportes</td></tr></tr></table></span><center><b style='font-size:13px'><a onclick="document.getElementById('sp_2').style.visibility='visible';">REPORTES</a></b></center></td></tr></table><table width='100%' cellspacing=0 cellpaddig=0><tr><td width='100px' valign='top'><a class='info' style='cursor:pointer;' onclick="modal2('zcalculo_tiempos2.php',0,0,50,50,'_blank'); ">
				<img src='imagenes/000/272/royal_ultimos_trimestre.jpg' width='48' border='0'>
				<span style='width:300px'>Calculo de Tiempos<br></span></a>
				<a class='info' style='cursor:pointer;' onclick="modal2('zconsulta_siniestro1.php',0,0,800,1000,'win'); ">
				...
				<img src='imagenes/000/289/monitor.png' width='48' border='0'>
