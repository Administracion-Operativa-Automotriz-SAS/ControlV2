<?php
	...
	function opciones_1(Dato)
			{
			if(Dato==359) { modal2('http://consultas.transitobogota.gov.co:8083/publico/index.php',0,0,700,900,'win3'); document.getElementById('sp_1').style.visibility='hidden'; return true;}
					if(Dato==332) { modal2('reportes2.php',0,0,0,0,'destino'); document.getElementById('sp_1').style.visibility='hidden'; return true;}
			...
			<tr><td align='center' style='font-size:14px'><b>MENU PRINCIPAL</b></td></tr><tr ><td class='menuprincipal' onclick='opciones_1(359);'>Consulta Comparendos BOGOTA</td></tr><tr ><td class='menuprincipal' onclick='opciones_1(332);'>Reportes</td></tr></tr></table></span><center><b style='font-size:13px'><a onclick="document.getElementById('sp_1').style.visibility='visible';">MENU PRINCIPAL</a></b></center></td></tr></table><table width='100%' cellspacing=0 cellpaddig=0><tr><td width='100px' valign='top'><a class='info' style='cursor:pointer;' onclick="modal2('http://consultas.transitobogota.gov.co:8083/publico/index.php',0,0,700,900,'win3'); ">
				...
				<img src='imagenes/332/impresora.png' width='48' border='0'>
