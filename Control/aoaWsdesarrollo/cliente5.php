...
$serverURL = 'http://app.aoacolombia.com/Control/aoaWsdesarrollo';
...
$token = $cliente->call(	"ObtenerToken", 												// Funcion a llamar
							 array (	"usuario" => "ike.rsa","clave" => "87654321"), 													
...
$Insercion = $cliente->call(  "InsertarSiniestro",                               
		array ( 
			...
			"numero"=>'19-2013-111-1234567', // numero de siniestro alfanumerico
			...
			"bancooccidente"=>'0' // 1 si es banco de occidente 0 si es estandar
			), 													
		"uri:$serverURL/$serverScript", 		//  namespace
