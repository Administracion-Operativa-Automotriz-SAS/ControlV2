...
DEFINE('DIRECTORIO_BACKUPS','Control/desarrollo/');
DEFINE('URL_INICIAL', 'http://www.aoacolombia.com/');
...
DEFINE('MYSQL_D', 'aoacol_carsmovil');
DEFINE('MYSQL_U', 'aoacol_carsmovil');
DEFINE('MYSQL_P','Movilpruebas');
