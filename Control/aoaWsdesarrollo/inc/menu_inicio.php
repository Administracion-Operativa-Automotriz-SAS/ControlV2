...
function construir_archivo_perfil()
{
	...
	fputs($A,"<td>
		...
		<td><a class='sinfo' style='cursor:pointer' onclick=\"window.open('marcoindex.php?Acc=reconstruye_inicio_perfil','destino');\"><img src='gifs/standar/Recycle.png' border=0>
				...
				<span style='width:200px'>Cambiar contrase�a</span></a></td>":"")."
		...
		?></td><td>
		<i>Desarrollado en: Aguila 8.0 Diciembre de 2010 &reg <a href='mailto:administracion@intercolombia.net'>Tecnologia AOA</a></i></td>");
	fclose($A);
}
